...
var len__5769__auto___16517 = arguments.length;
var i__5770__auto___16518 = (0);
while(true){
if((i__5770__auto___16518 < len__5769__auto___16517)){
args__5775__auto__.push((arguments[i__5770__auto___16518]));

var G__16519 = (i__5770__auto___16518 + (1));
i__5770__auto___16518 = G__16519;
continue;
} else {
}
break;
...
(portfolio.views.canvas.viewport.get_width.cljs$core$IFn$_invoke$arity$variadic = (function (frame,frame_body,width,p__16512){
var vec__16513 = p__16512;
var map__16516 = cljs.core.nth.call(null,vec__16513,(0),null);
var map__16516__$1 = cljs.core.__destructure_map.call(null,map__16516);
var level = cljs.core.get.call(null,map__16516__$1,new cljs.core.Keyword("zoom","level","zoom/level",1294076441));
...
/** @this {Function} */
(portfolio.views.canvas.viewport.get_width.cljs$lang$applyTo = (function (seq16508){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16509,G__16510,G__16511,seq16508__$3);
}));

portfolio.views.canvas.viewport.get_style_px = (function portfolio$views$canvas$viewport$get_style_px(style,prop){
var temp__5802__auto__ = (function (){var G__16520 = style;
var G__16520__$1 = (((G__16520 == null))?null:G__16520.getPropertyValue(prop));
if((G__16520__$1 == null)){
return null;
} else {
return cljs.core.not_empty.call(null,G__16520__$1);
}
})();
...
var args__5775__auto__ = [];
var len__5769__auto___16531 = arguments.length;
var i__5770__auto___16532 = (0);
while(true){
if((i__5770__auto___16532 < len__5769__auto___16531)){
args__5775__auto__.push((arguments[i__5770__auto___16532]));

var G__16533 = (i__5770__auto___16532 + (1));
i__5770__auto___16532 = G__16533;
continue;
} else {
}
break;
...
(portfolio.views.canvas.viewport.get_height.cljs$core$IFn$_invoke$arity$variadic = (function (frame,frame_body,height,p__16525){
var vec__16526 = p__16525;
var map__16529 = cljs.core.nth.call(null,vec__16526,(0),null);
var map__16529__$1 = cljs.core.__destructure_map.call(null,map__16529);
var level = cljs.core.get.call(null,map__16529__$1,new cljs.core.Keyword("zoom","level","zoom/level",1294076441));
var level__$1 = (function (){var or__5045__auto__ = level;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
var style = window.getComputedStyle(frame);
var root_el_style = (function (){var G__16530 = frame_body;
var G__16530__$1 = (((G__16530 == null))?null:G__16530.firstElementChild);
var G__16530__$2 = (((G__16530__$1 == null))?null:G__16530__$1.firstElementChild);
if((G__16530__$2 == null)){
return null;
} else {
return window.getComputedStyle(G__16530__$2);
}
})();
...
/** @this {Function} */
(portfolio.views.canvas.viewport.get_height.cljs$lang$applyTo = (function (seq16521){
...
var G__16524 = cljs.core.first.call(null,seq16521__$2);
var seq16521__$3 = cljs.core.next.call(null,seq16521__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16522,G__16523,G__16524,seq16521__$3);
}));
...
portfolio.views.canvas.viewport.prepare_canvas = (function portfolio$views$canvas$viewport$prepare_canvas(_,el,p__16534){
var map__16535 = p__16534;
var map__16535__$1 = cljs.core.__destructure_map.call(null,map__16535);
var opt = map__16535__$1;
var width = cljs.core.get.call(null,map__16535__$1,new cljs.core.Keyword("viewport","width","viewport/width",809992237));
var height = cljs.core.get.call(null,map__16535__$1,new cljs.core.Keyword("viewport","height","viewport/height",1951335772));
...
portfolio.views.canvas.viewport.finalize_canvas = (function portfolio$views$canvas$viewport$finalize_canvas(_,el,p__16536){
var map__16537 = p__16536;
var map__16537__$1 = cljs.core.__destructure_map.call(null,map__16537);
var opt = map__16537__$1;
var width = cljs.core.get.call(null,map__16537__$1,new cljs.core.Keyword("viewport","width","viewport/width",809992237));
var height = cljs.core.get.call(null,map__16537__$1,new cljs.core.Keyword("viewport","height","viewport/height",1951335772));
var frame = portfolio.components.canvas.get_iframe.call(null,el);
var frame_body = portfolio.components.canvas.get_iframe_body.call(null,el);
var w = portfolio.views.canvas.viewport.get_width.call(null,frame,frame_body,width,opt);
var h = portfolio.views.canvas.viewport.get_height.call(null,frame,frame_body,height,opt);
var vec__16538 = ((((((cljs.core.not_EQ_.call(null,"100%",w)) || (cljs.core.not_EQ_.call(null,"100%",h)))) && ((((!(typeof width === 'number'))) || ((((40) + width) < portfolio.views.canvas.viewport.get_available_width.call(null,el)))))))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["20px","rgba(0, 0, 0, 0.1) 0px 1px 5px 0px"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["0","none"], null));
var margin = cljs.core.nth.call(null,vec__16538,(0),null);
var shadow = cljs.core.nth.call(null,vec__16538,(1),null);
(el.style.height = h);
...
var vec__16541 = xs;
var v = cljs.core.nth.call(null,vec__16541,(0),null);
var h = cljs.core.nth.call(null,vec__16541,(1),null);
...
return portfolio.views.canvas.addons.create_toolbar_menu_button.call(null,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword("canvas","viewport","canvas/viewport",1810532963),new cljs.core.Keyword(null,"title","title",636505583),"Viewport",new cljs.core.Keyword(null,"default-value","default-value",232220170),cljs.core.update.call(null,new cljs.core.Keyword("viewport","defaults","viewport/defaults",2054751788).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword("viewport","padding","viewport/padding",-1583726021),portfolio.views.canvas.viewport.get_padding),new cljs.core.Keyword(null,"options","options",99638489),cljs.core.map.call(null,(function (p1__16544_SHARP_){
return cljs.core.update.call(null,p1__16544_SHARP_,new cljs.core.Keyword("viewport","padding","viewport/padding",-1583726021),portfolio.views.canvas.viewport.get_padding);
